...
';
	...
	echo "<h1><center><b>PROCEED TO CHECKOUT :</center></b></h1>";
...
echo '<div style="text-align: center;">
    <form action="pay.php">
        <button style="background-color: black; padding: 15px 30px; border: none; cursor: pointer;">
...
<br>
<center>
<td><form action="book.php"><button style="background-color: black; padding: 15px 30px; type="submit"; align=center;"><span style=color:white;><h3>Go back</h3></span></a></td></button></form>
